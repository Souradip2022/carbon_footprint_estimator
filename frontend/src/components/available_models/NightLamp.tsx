  ...
  return (
    ...
    ">
      <motion.h1
        ...
        className="mt-8 md:bg-gradient-to-br from-slate-300 to-slate-500 py-4 text-center text-[40px] md:bg-clip-text font-medium tracking-tight md:text-transparent text-secondary-foreground md:text-7xl w-full absolute lg:-top-[1000px] -top-[800px]">
